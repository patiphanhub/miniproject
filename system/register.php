...
<body>
    <div class="container">
        <div class="form-wrapper">
            ...
            ?>
            <form id="signup-form" method="POST" action="signup.php" onsubmit="return validatePasswords()">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="confirm-password" name="confirm_password" placeholder="กรุณากรอกรหัสผ่านอีกครั้ง" required>
                </div>
